        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition cursor-pointer ${saved
          ...
          <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800 flex flex-wrap items-center justify-between gap-4 bg-zinc-50/60 dark:bg-zinc-850/60 p-4 sm:p-5 rounded-2xl">
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={handleLike}
                className={`px-4 py-2.5 rounded-xl text-xs font-black transition flex items-center gap-2 cursor-pointer active:scale-95 shadow-sm border ${liked
