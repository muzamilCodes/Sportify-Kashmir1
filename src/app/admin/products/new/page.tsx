  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Add a new product to your store catalog</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div id="image-upload-section" className="bg-white rounded-xl shadow p-6 border border-gray-100">
        ...
        {/* Submit Buttons */}
        <div className="flex gap-4 sticky bottom-4 bg-white p-4 rounded-xl shadow-lg border border-gray-100 z-20">
          <button
            type="submit"
          ...
          <button type="button" onClick={() => router.push("/admin/products")} className="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition font-medium">
            Cancel
          </button>
        </div>
      </form>
