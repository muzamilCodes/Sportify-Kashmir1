...
import { Mail, ArrowLeft, Loader2, Sparkles, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-2">Reset Password</h1>
          <p className="text-gray-500">Enter your email address and we'll send you an OTP to reset your password.</p>
        </div>
